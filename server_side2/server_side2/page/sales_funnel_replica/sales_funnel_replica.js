...
frappe.pages["sales-funnel-replica"].on_page_load = function (wrapper) {
	...
	wrapper.sales_funnel_replica = new erpnext.SalesFunnel(wrapper);
...
erpnext.SalesFunnel = class SalesFunnel {
	...
	get_data(btn) {
		...
		const method_map = {
			sales_funnel: "server_side2.server_side2.page.sales_funnel_replica.sales_funnel_replica.get_funnel_data",
			opp_by_lead_source: "server_side2.server_side2.page.sales_funnel_replica.sales_funnel_replica..get_opp_by_lead_source",
			sales_pipeline: "server_side2.server_side2.page.sales_funnel_replica.sales_funnel_replica..get_pipeline_data",
		};
		frappe.call({
